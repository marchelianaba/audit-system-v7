...
# Program Kerja Pengawasan (PKP) — Audit Kinerja
...
Sasaran baku untuk skill `audit-kinerja`:
- Mengevaluasi renja, pk, lkjip unit kerja periode yang ditentukan.
- Mengidentifikasi temuan substantif sesuai PANDUAN skill audit-kinerja
